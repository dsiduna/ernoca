...
import CarInput from '../adminComponents/CarInput'
import { PictureItem } from '../adminComponents/AddCar'
import { useAddPendingCarMutation } from '../../redux/services/pendingService';

const EnlistCar = () => {
  const dispatch = useDispatch();
  const [addPendingCar, { isLoading: isAddPendingCarLoading }] = useAddPendingCarMutation();
  const initialState = {
    make: '',
    model: '',
  ...
  const handleAddCar = async () => {
    try {
      ...
      await addPendingCar(carData).then(() => {
