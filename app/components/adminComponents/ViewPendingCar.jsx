    ...
    <div className="pt-4 flex flex-col justify-center items-center">
      <div>
        ...
        <div className='pt-12'>
          ...
          <span className='italic text-green-700'> {formatCurrency(car.price)}</span>
        </div>
        <div>
          <span className='font-semibold text-lg'>Color:</span> {car.colour}
        </div>
        <div className='flex justify-start items-center gap-2'>
          ...
          <div className='cursor-pointer'>
            <Link href={`https://wa.me/${car.phone}`} target='_blank'>
              <svg fill="#25D366" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308" stroke="#25D366">
      ...
      <div className="flex justify-around items-center pt-8 gap-4">
        <div className="rounded-xl bg-[#201c78] hover:bg-[#464686] text-white text-center w-[108px] py-1 w-1/2 cursor-pointer"
          onClick={() => dispatch(updateModal('Approve Item'))}
        >
          Approve
        </div>
